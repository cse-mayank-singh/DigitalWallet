        ...
        try {
            ...
            switch (eventType) {
                ...
                case "TRANSFER_SUCCESS": {
                    ...
                    String receiverEmail = userClient.getProfile(receiverId).getEmail();
                    String amount    = String.valueOf(data.get("amount"));
                    Object balanceObj = data.getOrDefault("balance", "0");
                    String senderBalance   = String.valueOf(data.getOrDefault("senderBalance", balanceObj));
                    String receiverBalance = String.valueOf(data.getOrDefault("receiverBalance", balanceObj));
                    String reference = String.valueOf(data.getOrDefault("reference", "N/A"));
                    emailService.sendHtml(senderEmail, "Transfer Successful",
